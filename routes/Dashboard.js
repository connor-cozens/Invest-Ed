...
dashboard.get('/form/:tagNum', cors(),(req, res) =>{
    ...
    var query15 = "SELECT * FROM funderasiabases WHERE funderName ="
    var query16 = "SELECT * FROM funderasiaoperations WHERE funderName ="
    var query17 = "SELECT * FROM fundereducationsubsectors WHERE funderName ="
    var query18 = "SELECT * FROM funderinternationalbases WHERE funderName ="
    var query19 = "SELECT * FROM funderorganizationtraits WHERE funderName ="
