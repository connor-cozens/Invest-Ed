...
class formSubmission extends React.Component{
  ...
  render(){
    const {authorized, formSubmitted, formSubmitError, formUnauthorizedEditError, formStatus, inDB} = this.props;
    if (authorized === false) {
      return <Redirect to='/' />
    }
...
const mapStateToProps = (state) => {
  return {
    ...
    formUnauthorizedEditError: state.data.formUnauthorizedEditError
  };
}
